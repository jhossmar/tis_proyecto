    ...
    <div class="row-fluid">
        ...
        <?php
            ...
            while($row_actividades_empresa = mysql_fetch_array($resultado_actividades_empresa))
            {
                echo "<input  type=\"hidden\" id=\"A1".$CTA."\"  name=\"A1".$CTA."\"  value=\"".$row_actividades_empresa['id_actividad']."\" />
                      <input  type=\"hidden\" id=\"A2".$CTA."\"  name=\"A2".$CTA."\"  value=\"".$row_actividades_empresa['fecha_inicio']."\" />
                      <input  type=\"hidden\" id=\"A3".$CTA."\"  name=\"A3".$CTA."\"  value=\"".$row_actividades_empresa['fecha_fin']."\" />
                      <input  type=\"hidden\" id=\"A4".$CTA."\"  name=\"A4".$CTA."\"  value=\"".$row_actividades_empresa['descripcion']."\" />
                      <input  type=\"hidden\" id=\"A5".$CTA."\"  name=\"A5".$CTA."\"  value=\"".$row_actividades_empresa['entrega_producto']."\" />";
                $CTA++;
            }
        ...
        <?php
            ...
            while($row_Tareas = mysql_fetch_array($resultado_Tareas))
            {
                echo "<input  type=\"hidden\" id=\"T1".$CTT."\"  name=\"A1".$CTT."\"  value=\"".$row_Tareas['id_tarea']."\" />
                      <input  type=\"hidden\" id=\"T2".$CTT."\"  name=\"A2".$CTT."\"  value=\"".$row_Tareas['descripcion']."\" />
                      <input  type=\"hidden\" id=\"T3".$CTT."\"  name=\"A3".$CTT."\"  value=\"".$row_Tareas['responsable']."\" />
                      <input  type=\"hidden\" id=\"T4".$CTT."\"  name=\"A4".$CTT."\"  value=\"".$row_Tareas['actividad']."\" />
                      <input  type=\"hidden\" id=\"T5".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['fecha_inicio']."\" />
                      <input  type=\"hidden\" id=\"T6".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['fecha_fin']."\" />
                      <input  type=\"hidden\" id=\"T7".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['resultado_esperado']."\" />
                      <input  type=\"hidden\" id=\"T8".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['resultado_obtenido']."\" />
                      <input  type=\"hidden\" id=\"T9".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['color_tarea']."\" />
                      <input  type=\"hidden\" id=\"T10".$CTT."\"  name=\"A5".$CTT."\"  value=\"".$row_Tareas['color_texto']."\"  />";
                $CTT++;
            }
		...
		<?php
            $consulta_integrante = "SELECT u.id_usuario,u.nombre,u.apellido
                                    ...
                                    WHERE  i.grupo_empresa='$VerificarI->idGrupo' and u.id_usuario=i.usuario";
			$resultado_integrante = mysql_query($consulta_integrante,$conn);
