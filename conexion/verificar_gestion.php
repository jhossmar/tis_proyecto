...
class VerificarGestion
{
	...
	{               
				...
				$fecha_ini_1 = strtotime($this->act_ini_1);
				$fecha_fin_1 = strtotime($this->act_fin_1);

				if($this->act_1==1)
				{
				    if($this->fecha_actual<=$fecha_fin_1 && $this->fecha_actual >= $fecha_ini_1) 
				    {
				     	$this->act_1=1;
						$this->act_1_espera=false;											   
					}
					elseif($this->fecha_actual<=$fecha_fin_1 && $this->fecha_actual < $fecha_ini_1)
					{
							$this->act_1_espera=true;
					}					
				}
				if($this->fecha_actual > $fecha_fin_1) 
				{
	...
	{					        		
		...
		$fecha_ini_2=strtotime($this->act_ini_2);
		$fecha_fin_2=strtotime($this->act_fin_2);
		if($this->act_2 == 1) 
		{
			if($this->fecha_actual <= $fecha_fin_2 && $this->fecha_actual >= $fecha_ini_2) 
			{
				$this->act_2=1;
				$this->act_2_espera=false;					
			}
			elseif($this->fecha_actual <= $fecha_fin_2 && $this->fecha_actual < $fecha_ini_2)
			{
			    $this->act_2_espera=true;	
			}						
		}
		if($this->fecha_actual > $fecha_fin_2)
		{
	...
	{			    		
		...
		$fecha_ini_3=strtotime($this->act_ini_3);
		$fecha_fin_3=strtotime($this->act_fin_3);
			
			if ($this->act_3==1)
			{
				if($this->fecha_actual <= $fecha_fin_3 && $this->fecha_actual >= $fecha_ini_3) 
				{
					$this->act_3=1;
					$this->act_3_espera=false;
				}				
				elseif($this->fecha_actual <= $fecha_fin_3 && $this->fecha_actual < $fecha_ini_3)
				{
					$this->act_3_espera=true;		
				}								
			}
			if($this->fecha_actual > $fecha_fin_3)
			{
	...
	{					  			
		...
		$fecha_ini_4=strtotime($this->act_ini_4);
		$fecha_fin_4=strtotime($this->act_fin_4);
		if ($this->act_4==1) 
		{
			if($this->fecha_actual <= $fecha_fin_4 && $this->fecha_actual >= $fecha_ini_4) 
			{
				$act_4=1;
				$act_4_espera=false;
			}				
			elseif($this->fecha_actual <= $fecha_fin_4 && $this->fecha_actual < $fecha_ini_4)
			{
				$this->act_4_espera=true;		
			}								
		}
		if($this->fecha_actual > $fecha_fin_4)
		{
	...
	{					  				
		...
		$fecha_ini_5=strtotime($this->act_ini_5);
		$fecha_fin_5=strtotime($this->act_fin_5);
		if ($this->act_5==1) 
		{
			if($this->fecha_actual <= $fecha_fin_5 && $this->fecha_actual >= $fecha_ini_5) 
			{
				$this->act_5=1;
				$this->act_5_espera=false;
			}				
			elseif($this->fecha_actual <= $fecha_fin_5 && $this->fecha_actual < $fecha_ini_5)
			{
				$this->act_5_espera=true;
			}								
		}
		if($this->fecha_actual > $fecha_fin_5)
		{
	...
	{					  			
		...
		$fecha_ini_6=strtotime($this->act_ini_6);
		$fecha_fin_6=strtotime($this->act_fin_6);
		if($this->act_6==1)
		{
			if($this->fecha_actual <= $fecha_fin_6 && $this->fecha_actual >= $fecha_ini_6)
			{
				$this->act_6=1;
				$this->act_6_espera=false;
			}				
			elseif($this->fecha_actual <= $fecha_fin_6 && $this->fecha_actual < $fecha_ini_6)
			{
				$this->act_6_espera=true;
			}								
		}
		if($this->fecha_actual > $fecha_fin_6)
		{
	...
	{					  			
		...
		$fecha_ini_7=strtotime($this->act_ini_7);
		$fecha_fin_7=strtotime($this->act_fin_7);
		if($this->act_7==1)
		{
			if($this->fecha_actual <= $fecha_fin_7 && $this->fecha_actual >= $fecha_ini_7)
			{
				$this->act_7=1;
				$this->act_7_espera=false;
			}				
			elseif($this->fecha_actual <= $fecha_fin_7 && $this->fecha_actual < $fecha_ini_7)
			{
