...
<div>
	<ul class="breadcrumb">
		...
		<li>
			<a href="home_jefe_consultor">Home Jefe Consultor TIS{{ $gestion['nombre_gestion']}}</a>			
		</li>				
	</ul>
</div>
...
<div class="row-fluid">
	<div class="box span12">
		...
		<div class="box-content alerts">
			Bienvenido Jefe Consultor TIS a la <b>Gesti&oacute;n {{ $gestion['nombre_gestion']}}</b>, en este sitio usted podr&aacute; realizar la publicaci&oacute;n de avisos
